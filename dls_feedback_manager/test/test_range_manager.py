from XBPM_range_manager import 
import unittest
...
class RangeTests(unittest.TestCase):
    ...
    def setUp(self):
        self.XBPM1 = XBPM_range_manager.XBPMRangeManager('BL04I-EA-XBPM-', '01',
                                                         90e-9, 110e-9, 1.0,
                                                         3.0)
        self.XBPM2 = XBPM_range_manager.XBPMRangeManager('BL04I-EA-XBPM-', '02',
                                                         90e-9, 110e-9, 3.2,
                                                         3.0)
    ...
    def test_standard_naming(self):
        self.assertEqual(self.XBPM1.pv_prefix+self.XBPM1.xbpm_num,
                         'BL04I-EA-XBPM-01')
    ...
    def test_regular_expression(self):
        XBPM = XBPM_range_manager.XBPMRangeManager('BL04I-EA-XBMP-', '02', 1, 2,
                                                   3, 4)
        self.assertRegexpMatches(XBPM.pv_prefix+XBPM.xbpm_num,
                                 "BL04I-EA-XBPM-01")

    ## Error is raised as XBPM number is not between 1 and 9
    def test_XBPM_num(self):
        XBPM = XBPM_range_manager.XBPMRangeManager('BL04I-EA-XBPM-', '00', 1, 2,
                                                   3, 4)
    ...
    def test_initial_variable_inputs(self):
        self.assertRaises(AssertionError, XBPM_range_manager.XBPMRangeManager(
            'BL04I-EA-XBPM-', '01', 1, 11, "-9", 40.0))

    ## Error is raised when threshold percentage is outside of range (0-100)
    def test_invalid_threshold_percentage(self):
        self.assertRaises(AssertionError, XBPM_range_manager.XBPMRangeManager(
            'BL04I-EA-XBPM-', '01', 90e-9, 110e-9, 1.0, -84))
