...
xbpm1_pid_params = [(XBPM_pid_params.XBPMPIDParams(KP=-4.00e-5, KI=0.830,
                                                   KD=0.000, feedback="FDBK1",
                                                   position="Y1")),
                    (XBPM_pid_params.XBPMPIDParams(KP=1.80e-5, KI=0.830,
                                                   KD=0.000, feedback="FDBK2",
                                                   position="X1"))]
xbpm2_pid_params = [(XBPM_pid_params.XBPMPIDParams(KP=-4.00e-5, KI=0.830,
                                                   KD=0.000, feedback="FDBK3",
                                                   position="Y2")),
                    (XBPM_pid_params.XBPMPIDParams(KP=1.80e-5, KI=0.830,
                                                   KD=0.000, feedback="FDBK4",
                                                   position="X2"))]
